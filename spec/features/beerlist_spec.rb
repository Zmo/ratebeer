...
describe "Beerlist page" do
  ...
  it "shows the beers by default in alphabetical order", :js => true do
    visit beerlist_path
  ...
  it "shows the beers ordered by style when clicking on style", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
    click_link "Style"
  ...
  it "shows the beers ordered by brewery when clicking on brewery", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(2)')
    click_link "Brewery"
